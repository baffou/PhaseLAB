...
%% Creation of the temperature medium
clear Med
...
%% compute again without re-calculating the Green's functions to save time
IMT = IMs.TMPprocess(Med,'g',0.4,'nLoop',10,'imExpander',true,'TO',22, 'GreenOPD', GreenW, 'GreenT_z0', GreenT);
