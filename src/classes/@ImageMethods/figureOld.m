function [hfig0out,UIk0,cb0] = figureOld(IM,varargin)
...
hand.UIalpha_nmax = uicontrol('Parent',hpMeasurements,'Style','Edit','string','70','HorizontalAlignment','Center');
hand.UIalpha_bkgThick = uicontrol('Parent',hpMeasurements,'Style','Edit','string','5','HorizontalAlignment','Center');
