...
c     save the file
      ...
      call writehdf5mic(Eimagexneg,Eimageyneg,Eimagezneg,nfft2d ,imaxk0
     $     ,Ediffkzneg,k,name,group_idim_loop)
      name='Image+incident'//fil3//'kz<0'
      call writehdf5mic(Eimageincxneg,Eimageincyneg ,Eimageinczneg
     $     ,nfft2d,imaxk0,Ediffkzneg,k,name ,group_idim_loop)
      ...
      if (iloop.eq.1) then
         ...
         datasetname='k0'
         call hdf5write(group_idopt_loop,datasetname,k0,dim)
