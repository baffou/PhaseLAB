classdef PCmask < handle & matlab.mixin.Copyable
    ...
    properties
        A       % tranmittance of the mask
        phi     % phase shift of the mask
        NA0     % radius of the ring, or distance from the center of the disc
    ...
    methods
        ...
        function val = mask(obj,var1,IL)
            % displays an image of the mask, but requires an image or a
            ...
            val = (1-pattern + obj.A*pattern) .* exp(1i*obj.phi*pattern);
