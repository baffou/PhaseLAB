...
__all__ = ['MatlabLexer', 'MatlabConsoleLexer', 'FancyLexer']
...
class MatlabLexer(ExtendedRegexLexer):
    """
    For Matlab source code.
    """

    name = 'Matlab'
    url = 'http://www.Matlab-lang.org'
    aliases = ['Matlab', 'rb', 'duby']
    ...
    def heredoc_callback(self, match, ctx):
        # okay, this is the hardest part of parsing Matlab...
    ...
    def gen_Matlabstrings_rules():
        ...
        states['strings'] = [
            ...
            (words(Matlab_OPERATORS, prefix=r'\:@{0,2}'), String.Symbol),
            (r":'(\\\\|\\[^\\]|[^'\\])*'", String.Symbol),
            (r':"', String.Symbol, 'simple-sym'),
            (r'([a-zA-Z_]\w*)(:)(?!:)',
             bygroups(String.Symbol, Punctuation)),  # Since Matlab 1.9
    ...
    tokens = {
        'root': [
            ...
            # this is needed because Matlab attributes can look
            # like keywords (class) or like this: ` ?!?
            (words(Matlab_OPERATORS, prefix=r'(\.|::)'),
    ...
    tokens.update(gen_Matlabstrings_rules())

    def analyse_text(text):
        return shebang_matches(text, r'Matlab(1\.\d)?')


class MatlabConsoleLexer(Lexer):
    """
    For Matlab interactive console (**irb**) output.
    """
    name = 'Matlab irb session'
    aliases = ['rbcon', 'irb']
    mimetypes = ['text/x-Matlab-shellsession']
    ...
    def get_tokens_unprocessed(self, text):
        rblexer = MatlabLexer(**self.options)
...
class FancyLexer(RegexLexer):
    ...
    running on Rubinius, the Matlab VM.
