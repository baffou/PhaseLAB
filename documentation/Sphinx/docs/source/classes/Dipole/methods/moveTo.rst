.. dropdown:: **moveTo** |subTitle| moves the dipole to aa given position. |/subTitle|
    ...
    The arguments can be either the 3 coordinates in *x*, *y*, and *z* axes; or a 3-vector; or a Name-Value structure where the Names are ``'x'``, ``'y``, and/or ``'z'``, in any order.